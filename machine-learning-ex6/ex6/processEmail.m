...
while ~isempty(email_contents)
    ...
    % found: If the word you should add the index of the word into the word indices variable.
    ...
    %       vocabulary list.
    % 
    % Use strcmp(str1, str2) to compare two strings (str1 and
    ...
    for i = 1: length(vocabList)
        if strcmp(str,vocabList{i})==1
          word_indices =  [word_indices; i]; %adds object to the array.
        end
    end
